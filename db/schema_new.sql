...
CREATE TABLE entry_passes (
    ...
    purpose VARCHAR(255) NOT NULL,    valid_from DATETIME NOT NULL,
    valid_until DATETIME NOT NULL,
    entry_time DATETIME NULL,
    exit_time DATETIME NULL,
    entry_status ENUM('entered', 'exited') NULL,
    status ENUM('active', 'expired', 'cancelled', 'deleted') DEFAULT 'active',
